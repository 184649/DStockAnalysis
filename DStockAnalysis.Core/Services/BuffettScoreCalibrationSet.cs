...
public static class BuffettScoreCalibrationSet
{
    ...
    private static List<BuffettScoreTrainingSample> Build()
    {
        ...
        L.Add(S("優良A", "A優良", Mk(16, 2.2, 15, 50, 14, 4, 5, 2.6, 40, 400000, 250000, roa: 8, npm: 10, ocfm: 14, rev3: 5, rev10: 3, npg: 6, epsg: 6, ord: 14, consec: 8, noncut: 10, divG5: 6, totalYield: 2.6), 78, 90, gA, rationale: "良い会社・妥当価格。"));
        L.Add(S("優良B", "A優良", Mk(18, 2.8, 16, 45, 16, 5, 6, 2.2, 35, 420000, 260000, roa: 9, npm: 11, ocfm: 15, rev3: 5, rev10: 3, npg: 6, epsg: 7, ord: 16, consec: 6, noncut: 8, divG5: 5, buyback: 20000, totalYield: 2.2), 78, 90, gA, rationale: "収益力・成長のバランス良。"));
        L.Add(S("優良C", "A優良", Mk(14, 1.8, 13, 55, 12, 4, 5, 3.0, 45, 380000, 240000, roa: 8, npm: 9, ocfm: 13, rev3: 4, rev10: 3, npg: 5, epsg: 5, ord: 12, consec: 10, noncut: 12, divG5: 5, totalYield: 3.0), 78, 90, gA, rationale: "堅実・割安寄り。"));
        L.Add(S("優良D", "A優良", Mk(20, 3.2, 17, 48, 15, 5, 6, 2.0, 38, 410000, 250000, roa: 9, npm: 11, ocfm: 14, rev3: 6, rev10: 4, npg: 7, epsg: 7, ord: 15, consec: 7, noncut: 9, divG5: 6, totalYield: 2.0), 78, 90, gA, rationale: "やや割高だが質が高い。"));
        L.Add(S("優良E", "A優良", Mk(15, 2.0, 14, 52, 13, 4, 5, 2.8, 42, 390000, 245000, roa: 8, npm: 10, ocfm: 14, rev3: 5, rev10: 3, npg: 6, epsg: 6, ord: 13, consec: 9, noncut: 11, divG5: 5, totalYield: 2.8), 78, 90, gA, rationale: "バランス型優良。"));
        ...
        for (int i = 0; i < 5; i++)
        {
            L.Add(S($"ヒット型{i + 1}", "ヒット依存", Mk(8 + i * 2, 2.5 + i * 0.5, 26 + i, 50, 18 + i * 2, 0, 0, 1.0, 15, 80000, 0,
                roa: 15, npm: 18, ocfm: 18, rev3: 18 + i * 2, rev10: 0, npg: 0, epsg: 0, eps: 200, mktcap: 200000,
                theme: "ゲーム,アニメ,IP,キャラクター,娯楽", name: "テストヒット企業"), 70, 84, gBA, prohibitS: true, rationale: "短期は高収益だが長期実績・CF安定が不足。Sにしない。"));
        }
