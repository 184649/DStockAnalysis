...
public class YahooFinanceClientTests
{
    private const string Sample = @"{""quoteSummary"":{""result"":[{
        ...
        ""summaryDetail"":{""trailingPE"":{""raw"":9.1648},""dividendYield"":{""raw"":0.0365},""payoutRatio"":{""raw"":0.3218}},
        ""defaultKeyStatistics"":{""priceToBook"":{""raw"":0.8835},""trailingEps"":{""raw"":295.26}},
        ""financialData"":{""returnOnEquity"":{""raw"":0.10233}}
    }],""error"":null}}";
